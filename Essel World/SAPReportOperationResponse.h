...
@class SAPReportOperationResponseBody;
#import "SAPRequestResultHandler.h"
#import "DDXML.h"



@interface SAPReportOperationResponse : NSObject <SAPISerializableObject>


@property (retain,nonatomic,getter=getHeader) SAPOperationRealm* Header;

@property (retain,nonatomic,getter=getBody) SAPReportOperationResponseBody* Body;
-(id)init;
