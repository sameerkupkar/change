...
{
    DDXMLNode* child=[SAPHelper getAttribute:node name:name];
    return child!=nil;
}
...
{
    DDXMLElement* child=[SAPHelper getNode:node name:name index:index];
    if(child!=nil)
    {
        DDXMLNode* nilAttr=[SAPHelper getAttribute:child name:@"nil" url:XSI];
        return nilAttr==nil;
    }
    return NO;
}
