...
@implementation SAPAuthenticateOperationResponseBody
...
+ (SAPAuthenticateOperationResponseBody *)createWithXml:(DDXMLElement *)__node __request:(SAPRequestResultHandler*) __request
{
    ...
    SAPAuthenticateOperationResponseBody* obj = [[self alloc] init];
...
-(void) serialize:(DDXMLElement*)__parent __request:(SAPRequestResultHandler*) __request
{
    ...
    DDXMLElement* __sessionIDItemElement=[__request writeElement:sessionID type:[NSString class] name:@"sessionID" URI:@"" parent:__parent skipNullProperty:YES];
